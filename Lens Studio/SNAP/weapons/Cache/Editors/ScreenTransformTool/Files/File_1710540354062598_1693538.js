...
class Point {
    ...
    containsWorldPoint(point) {
        return this.containsScreenPoint(_GizmoUtils.module.GizmoUtils.worldPointToScreenPoint(this.screenTransform, point));
    }
    ...
    setupInteractions() { }
    getAABBMinMax() {
        const a = this.screenTransform.localPointToScreenPoint(_GizmoUtils.module.GizmoUtils.TOP_LEFT);
        const b = this.screenTransform.localPointToScreenPoint(_GizmoUtils.module.GizmoUtils.TOP_RIGHT);
        const c = this.screenTransform.localPointToScreenPoint(_GizmoUtils.module.GizmoUtils.BOTTOM_LEFT);
        const d = this.screenTransform.localPointToScreenPoint(_GizmoUtils.module.GizmoUtils.BOTTOM_RIGHT);
