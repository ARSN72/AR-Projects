...
bool l9_1=float(l9_0<varPackedTex.y)!=0.0;
bool l9_2;
if (!l9_1)
{
l9_2=float(varPackedTex.y<edgeSize)!=0.0;
}
else
{
l9_2=l9_1;
...
bool l9_4=float(varPackedTex.x<edgeSize)!=0.0;
bool l9_5;
if (!l9_4)
{
l9_5=float(l9_0<varPackedTex.x)!=0.0;
}
else
{
l9_5=l9_4;
...
{
if (l9_9<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_14=ngsPixelShader(l9_13);
...
sc_writeFragData0(vec4(max(0.0,1.00392-l9_17),min(1.0,l9_17+0.00392157),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_18).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_19=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_18).xy);
float l9_20=packValue(l9_19);
vec4 l9_21=vec4(0.0);
l9_21.x=l9_20;
vec4 l9_23=l9_21;
l9_23.y=packValue(l9_19);
vec4 l9_25=l9_23;
l9_25.z=packValue(l9_19);
vec4 l9_27=l9_25;
l9_27.w=packValue(l9_19);
vec4 l9_29=vec4(0.0);
l9_29.x=packValue(l9_19);
vec4 l9_31=l9_29;
l9_31.y=packValue(l9_19);
vec4 l9_33=l9_31;
l9_33.z=packValue(l9_19);
vec4 l9_34=l9_33;
l9_34.w=packValue(l9_19);
int l9_35=int(l9_16.w*255.0);
float l9_36=packValue(l9_35);
vec4 l9_37=vec4(0.0);
l9_37.x=l9_36;
vec4 l9_39=l9_37;
l9_39.y=packValue(l9_35);
vec4 l9_41=l9_39;
l9_41.z=packValue(l9_35);
vec4 l9_42=l9_41;
l9_42.w=packValue(l9_35);
sc_writeFragData0(l9_34);
sc_writeFragData1(l9_27);
sc_writeFragData2(l9_42);
...
if (l9_54==0)
{
l9_57=texture2D(sc_OITAlpha0,l9_43);
l9_56=texture2D(sc_OITDepthLow0,l9_43);
l9_55=texture2D(sc_OITDepthHigh0,l9_43);
}
else
{
l9_57=l9_50;
...
if (l9_54==1)
{
l9_53=texture2D(sc_OITAlpha1,l9_43);
l9_52=texture2D(sc_OITDepthLow1,l9_43);
l9_51=texture2D(sc_OITDepthHigh1,l9_43);
}
else
{
l9_53=l9_57;
...
l9_58[6]=l9_44[6];
l9_58[7]=l9_44[7];
unpackValues(l9_51.w,l9_54,l9_58);
unpackValues(l9_51.z,l9_54,l9_58);
unpackValues(l9_51.y,l9_54,l9_58);
unpackValues(l9_51.x,l9_54,l9_58);
unpackValues(l9_52.w,l9_54,l9_58);
unpackValues(l9_52.z,l9_54,l9_58);
unpackValues(l9_52.y,l9_54,l9_58);
unpackValues(l9_52.x,l9_54,l9_58);
int l9_67[8];
l9_67[0]=l9_45[0];
l9_67[1]=l9_45[1];
l9_67[2]=l9_45[2];
...
l9_67[6]=l9_45[6];
l9_67[7]=l9_45[7];
unpackValues(l9_53.w,l9_54,l9_67);
unpackValues(l9_53.z,l9_54,l9_67);
unpackValues(l9_53.y,l9_54,l9_67);
unpackValues(l9_53.x,l9_54,l9_67);
}
l9_50=l9_53;
l9_49=l9_52;
l9_48=l9_51;
...
mediump vec4 l9_72=texture2D(sc_OITFilteredDepthBoundsTexture,l9_43);
vec2 l9_73=l9_72.xy;
int l9_74;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_74=encodeDepth(((1.0-l9_72.x)*1000.0)+l9_75,l9_73);
}
#else
{
l9_74=0;
...
#endif
int l9_76=encodeDepth(viewSpaceDepth(),l9_73);
vec4 l9_77;
l9_77=l9_16*l9_16.w;
vec4 l9_78;
int l9_79=0;
...
if (l9_79<8)
{
int l9_80=l9_44[l9_79];
int l9_81=l9_76-l9_74;
...
if (l9_83)
{
vec3 l9_84=l9_77.xyz*(1.0-(float(l9_45[l9_79])*0.00392157));
