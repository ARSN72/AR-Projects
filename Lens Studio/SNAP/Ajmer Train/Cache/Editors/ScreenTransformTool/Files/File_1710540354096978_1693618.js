...
class GizmoPool {
    ...
    createFromObjects(objects, fijiObjects) {
        ...
        _Gizmo.module.Gizmo.ActiveGizmos = this.filterOutDependentGizmos(this.activeGizmos);
    }
    ...
    destroyActiveGizmos() {
        _Gizmo.module.Gizmo.ActiveGizmos = [];
    ...
    spawnNewGizmo() {
        ...
        newGizmo.setLayer(_Utils.module.Utils.SYSTEM_LAYER);
        newGizmo.hide();
