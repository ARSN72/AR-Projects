...
vec4 l9_1=vec4(baseColor.x,baseColor.y,baseColor.z,vec4(0.0).w);
l9_1.w=baseColor.w;
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec4 l9_2=ngsPixelShader(l9_1);
vec4 l9_3=max(l9_2,vec4(0.0));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_6=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_6).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_7=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_6).xy);
float l9_8=packValue(l9_7);
vec4 l9_9=vec4(0.0);
l9_9.x=l9_8;
vec4 l9_11=l9_9;
l9_11.y=packValue(l9_7);
vec4 l9_13=l9_11;
l9_13.z=packValue(l9_7);
vec4 l9_15=l9_13;
l9_15.w=packValue(l9_7);
vec4 l9_17=vec4(0.0);
l9_17.x=packValue(l9_7);
vec4 l9_19=l9_17;
l9_19.y=packValue(l9_7);
vec4 l9_21=l9_19;
l9_21.z=packValue(l9_7);
vec4 l9_22=l9_21;
l9_22.w=packValue(l9_7);
int l9_23=int(l9_4.w*255.0);
...
vec4 l9_30=l9_29;
l9_30.w=packValue(l9_23);
sc_writeFragData0(l9_22);
sc_writeFragData1(l9_15);
sc_writeFragData2(l9_30);
...
#if (sc_OITCompositingPass)
{
vec2 l9_31=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_42==0)
{
l9_45=texture2D(sc_OITAlpha0,l9_31);
l9_44=texture2D(sc_OITDepthLow0,l9_31);
l9_43=texture2D(sc_OITDepthHigh0,l9_31);
}
else
{
l9_45=l9_38;
...
if (l9_42==1)
{
l9_41=texture2D(sc_OITAlpha1,l9_31);
l9_40=texture2D(sc_OITDepthLow1,l9_31);
l9_39=texture2D(sc_OITDepthHigh1,l9_31);
}
else
{
l9_41=l9_45;
...
if (any(notEqual(l9_39,vec4(0.0)))||any(notEqual(l9_40,vec4(0.0))))
{
int l9_46[8];
l9_46[0]=l9_32[0];
l9_46[1]=l9_32[1];
...
l9_46[6]=l9_32[6];
l9_46[7]=l9_32[7];
unpackValues(l9_39.w,l9_42,l9_46);
unpackValues(l9_39.z,l9_42,l9_46);
unpackValues(l9_39.y,l9_42,l9_46);
unpackValues(l9_39.x,l9_42,l9_46);
unpackValues(l9_40.w,l9_42,l9_46);
unpackValues(l9_40.z,l9_42,l9_46);
unpackValues(l9_40.y,l9_42,l9_46);
unpackValues(l9_40.x,l9_42,l9_46);
int l9_55[8];
l9_55[0]=l9_33[0];
l9_55[1]=l9_33[1];
l9_55[2]=l9_33[2];
...
l9_55[6]=l9_33[6];
l9_55[7]=l9_33[7];
unpackValues(l9_41.w,l9_42,l9_55);
unpackValues(l9_41.z,l9_42,l9_55);
unpackValues(l9_41.y,l9_42,l9_55);
unpackValues(l9_41.x,l9_42,l9_55);
}
l9_38=l9_41;
l9_37=l9_40;
l9_36=l9_39;
...
mediump vec4 l9_60=texture2D(sc_OITFilteredDepthBoundsTexture,l9_31);
vec2 l9_61=l9_60.xy;
int l9_62;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_62=encodeDepth(((1.0-l9_60.x)*1000.0)+l9_63,l9_61);
}
#else
{
l9_62=0;
...
#endif
int l9_64=encodeDepth(viewSpaceDepth(),l9_61);
vec4 l9_65;
l9_65=l9_4*l9_4.w;
vec4 l9_66;
int l9_67=0;
...
if (l9_67<8)
{
int l9_68=l9_32[l9_67];
int l9_69=l9_64-l9_62;
bool l9_70=l9_68<l9_69;
bool l9_71;
if (l9_70)
{
l9_71=l9_32[l9_67]>0;
...
if (l9_71)
{
vec3 l9_72=l9_65.xyz*(1.0-(float(l9_33[l9_67])*0.00392157));
l9_66=vec4(l9_72.x,l9_72.y,l9_72.z,l9_65.w);
}
else
{
l9_66=l9_65;
