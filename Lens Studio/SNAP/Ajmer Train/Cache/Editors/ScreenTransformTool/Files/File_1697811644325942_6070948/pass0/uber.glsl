...
//sampler sampler inactive_txtSmpSC 2:19
...
//texture texture2D inactive_txt 2:1:2:19
...
//texture texture2D sc_ScreenTexture 2:13:2:24
//SG_REFLECTION_END
...
{
vec4 param_4;
Node126_Switch(0.0,vec4(0.0),vec4(0.0),vec4(1.0,0.0,0.0,0.0),param_4,Globals);
float param_10;
Node287_Switch(0.0,0.0,0.0,0.0,param_10,Globals);
float param_16;
Node281_Switch(0.0,0.0,0.0,0.0,param_16,Globals);
float param_19;
Node268_Remap(shapeWidthX,param_19,0.0,1.0,param_10,param_16,Globals);
float param_29;
Node282_Switch(0.0,0.5,0.0,0.0,param_29,Globals);
float param_35;
Node289_Switch(0.0,0.0,0.0,0.0,param_35,Globals);
float param_41;
Node286_Switch(0.0,0.0,0.0,0.0,param_41,Globals);
float param_44;
Node277_Remap(shapeHeightY,param_44,0.0,1.0,param_35,param_41,Globals);
float param_54;
Node293_Switch(0.0,-0.5,0.0,0.0,param_54,Globals);
vec2 l9_0=vec2(0.0);
l9_0.x=param_19+(1.0-(xOffset+param_29));
vec2 l9_1=l9_0;
l9_1.y=param_44+(yOffset+param_54);
vec2 l9_2=Globals.Surface_UVCoord0+l9_1;
vec2 param_59;
Node92_Rotate_Coords(l9_2,0.0,vec2(0.5),param_59,Globals);
vec2 l9_3=vec2(0.0);
l9_3.x=0.0;
vec2 l9_4=l9_3;
l9_4.y=0.0;
vec2 param_64;
Node94_Rotate_Coords(param_59+l9_4,0.0,vec2(0.5),param_64,Globals);
vec2 param_69;
Node100_Rotate_Coords(param_64,shapeRotation,vec2(0.5),param_69,Globals);
float param_72;
Node138_Remap(0.0,param_72,0.0,1.0,1.005,0.8,Globals);
float param_79;
Node21_Remap(shapeWidthX,param_79,0.0,1.0,0.0,1.0,Globals);
float param_86;
Node22_Remap(shapeHeightY,param_86,0.0,1.0,0.0,1.0,Globals);
vec2 l9_5=vec2(0.0);
l9_5.x=param_79;
vec2 l9_6=l9_5;
l9_6.y=param_86;
float l9_7=max(min(min(abs(shapeRoundness),param_79),param_86),0.001);
float param_93;
Node39_Remap(shapeWidthX,param_93,0.0,1.0,0.0,1.0,Globals);
float param_100;
Node42_Remap(shapeHeightY,param_100,0.0,1.0,0.0,1.0,Globals);
float param_107;
Node57_Remap(shapeRoundness,param_107,0.001,0.01,0.0,0.16,Globals);
float param_114;
Node47_Remap(shapeRoundness,param_114,0.0,1.0,0.0,1.0,Globals);
vec4 l9_8=vec4(param_4.x,param_4.y,param_4.z,vec4(0.0).w);
l9_8.w=0.0;
vec2 param_123;
Node113_Rotate_Coords(l9_2,shapeRotation,vec2(0.5),param_123,Globals);
float l9_9=1.0-(length(max((abs((param_123*vec2(2.0))+vec2(-1.0))-l9_6)+vec2(l9_7),vec2(0.0)))/l9_7);
vec4 param_130;
Node149_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),vec4(1.0,0.0,0.0,0.0),param_130,Globals);
float l9_10=(clamp((l9_9/fwidth(l9_9))+0.001,0.001,1.001)-0.001)*shapeAlpha;
float param_133;
Node171_Remap((l9_10-max(0.0,l9_10))+l9_10,param_133,0.0,1.0,0.0,1.0,Globals);
Value1=mix(l9_8,param_130,vec4(param_133));
Result=Value1;
}
else
{
vec4 param_143;
Node126_Switch(0.0,vec4(0.0),vec4(0.0),vec4(1.0,0.0,0.0,0.0),param_143,Globals);
float param_149;
Node287_Switch(0.0,0.0,0.0,0.0,param_149,Globals);
float param_155;
Node281_Switch(0.0,0.0,0.0,0.0,param_155,Globals);
float param_158;
Node268_Remap(shapeWidthX,param_158,0.0,1.0,param_149,param_155,Globals);
float param_168;
Node282_Switch(0.0,0.5,0.0,0.0,param_168,Globals);
float param_174;
Node289_Switch(0.0,0.0,0.0,0.0,param_174,Globals);
float param_180;
Node286_Switch(0.0,0.0,0.0,0.0,param_180,Globals);
float param_183;
Node277_Remap(shapeHeightY,param_183,0.0,1.0,param_174,param_180,Globals);
float param_193;
Node293_Switch(0.0,-0.5,0.0,0.0,param_193,Globals);
vec2 l9_11=vec2(0.0);
l9_11.x=param_158+(1.0-(xOffset+param_168));
vec2 l9_12=l9_11;
l9_12.y=param_183+(yOffset+param_193);
vec2 l9_13=Globals.Surface_UVCoord0+l9_12;
vec2 param_198;
Node92_Rotate_Coords(l9_13,0.0,vec2(0.5),param_198,Globals);
vec2 l9_14=vec2(0.0);
l9_14.x=0.0;
vec2 l9_15=l9_14;
l9_15.y=0.0;
vec2 param_203;
Node94_Rotate_Coords(param_198+l9_15,0.0,vec2(0.5),param_203,Globals);
vec2 param_208;
Node100_Rotate_Coords(param_203,shapeRotation,vec2(0.5),param_208,Globals);
float param_211;
Node138_Remap(0.0,param_211,0.0,1.0,1.005,0.8,Globals);
float param_218;
Node21_Remap(shapeWidthX,param_218,0.0,1.0,0.0,1.0,Globals);
float param_225;
Node22_Remap(shapeHeightY,param_225,0.0,1.0,0.0,1.0,Globals);
vec2 l9_16=vec2(0.0);
l9_16.x=param_218;
vec2 l9_17=l9_16;
l9_17.y=param_225;
float l9_18=max(min(min(abs(shapeRoundness),param_218),param_225),0.001);
float param_232;
Node39_Remap(shapeWidthX,param_232,0.0,1.0,0.0,1.0,Globals);
float param_239;
Node42_Remap(shapeHeightY,param_239,0.0,1.0,0.0,1.0,Globals);
float param_246;
Node57_Remap(shapeRoundness,param_246,0.001,0.01,0.0,0.16,Globals);
float param_253;
Node47_Remap(shapeRoundness,param_253,0.0,1.0,0.0,1.0,Globals);
vec4 l9_19=vec4(param_143.x,param_143.y,param_143.z,vec4(0.0).w);
l9_19.w=0.0;
vec2 param_262;
Node113_Rotate_Coords(l9_13,shapeRotation,vec2(0.5),param_262,Globals);
float l9_20=1.0-(length(max((abs((param_262*vec2(2.0))+vec2(-1.0))-l9_17)+vec2(l9_18),vec2(0.0)))/l9_18);
vec4 param_269;
Node149_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),vec4(1.0,0.0,0.0,0.0),param_269,Globals);
float l9_21=(clamp((l9_20/fwidth(l9_20))+0.001,0.001,1.001)-0.001)*shapeAlpha;
float param_272;
Node171_Remap((l9_21-max(0.0,l9_21))+l9_21,param_272,0.0,1.0,0.0,1.0,Globals);
vec4 l9_22=mix(l9_19,param_269,vec4(param_272));
vec4 l9_23=vec4(0.0);
l9_23.x=l9_22.x;
vec4 l9_24=l9_23;
l9_24.y=l9_22.y;
...
int inactive_txtGetStereoViewIndex()
{
int l9_0;
...
if (Bool1!=0.0)
{
Value1=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),((Globals.Surface_UVCoord0-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
Result=Value1;
}
else
{
Default=sc_SampleTextureBiasOrLevel(inactive_txtDims.xy,inactive_txtLayout,inactive_txtGetStereoViewIndex(),((Globals.Surface_UVCoord0-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_inactive_txt)!=0),inactive_txtTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_inactive_txt,SC_SOFTWARE_WRAP_MODE_V_inactive_txt),(int(SC_USE_UV_MIN_MAX_inactive_txt)!=0),inactive_txtUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_inactive_txt)!=0),inactive_txtBorderColor,0.0,inactive_txt);
Result=Default;
}
}
...
l9_6=l9_8*vec4(1.0,1.0,1.0,0.0);
}
bool l9_9=l9_4!=0.0;
bool l9_10;
if (!l9_9)
...
{
vec4 l9_12;
Node366_If_else(0.0,vec4(0.0),vec4(0.0),l9_12,l9_3);
vec4 l9_13=vec4(0.0);
l9_13.x=0.964;
vec4 l9_14=l9_13;
l9_14.y=0.964;
...
{
vec4 l9_17;
Node366_If_else(0.0,vec4(0.0),vec4(0.0),l9_17,l9_3);
vec4 l9_18=vec4(0.0);
l9_18.x=0.761;
vec4 l9_19=l9_18;
l9_19.y=0.82;
...
vec3 l9_22=mix(l9_6.xyz,l9_11.xyz,vec3(l9_11.w));
float l9_23=clamp((l9_6.w+l9_11.w)+0.001,0.001,1.001)-0.001;
...
{
if (l9_23<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_25=ngsPixelShader(l9_24);
vec4 l9_26=max(l9_25,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_28=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_28),min(1.0,l9_28+0.00392157),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_29).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_30=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_29).xy);
float l9_31=packValue(l9_30);
vec4 l9_32=vec4(0.0);
l9_32.x=l9_31;
vec4 l9_34=l9_32;
l9_34.y=packValue(l9_30);
vec4 l9_36=l9_34;
l9_36.z=packValue(l9_30);
vec4 l9_38=l9_36;
l9_38.w=packValue(l9_30);
vec4 l9_40=vec4(0.0);
l9_40.x=packValue(l9_30);
vec4 l9_42=l9_40;
l9_42.y=packValue(l9_30);
vec4 l9_44=l9_42;
l9_44.z=packValue(l9_30);
vec4 l9_45=l9_44;
l9_45.w=packValue(l9_30);
int l9_46=int(l9_27.w*255.0);
float l9_47=packValue(l9_46);
vec4 l9_48=vec4(0.0);
l9_48.x=l9_47;
vec4 l9_50=l9_48;
l9_50.y=packValue(l9_46);
vec4 l9_52=l9_50;
l9_52.z=packValue(l9_46);
vec4 l9_53=l9_52;
l9_53.w=packValue(l9_46);
sc_writeFragData0(l9_45);
sc_writeFragData1(l9_38);
sc_writeFragData2(l9_53);
...
if (l9_65==0)
{
l9_68=texture2D(sc_OITAlpha0,l9_54);
l9_67=texture2D(sc_OITDepthLow0,l9_54);
l9_66=texture2D(sc_OITDepthHigh0,l9_54);
}
else
{
l9_68=l9_61;
...
if (l9_65==1)
{
l9_64=texture2D(sc_OITAlpha1,l9_54);
l9_63=texture2D(sc_OITDepthLow1,l9_54);
l9_62=texture2D(sc_OITDepthHigh1,l9_54);
}
else
{
l9_64=l9_68;
...
l9_69[6]=l9_55[6];
l9_69[7]=l9_55[7];
unpackValues(l9_62.w,l9_65,l9_69);
unpackValues(l9_62.z,l9_65,l9_69);
unpackValues(l9_62.y,l9_65,l9_69);
unpackValues(l9_62.x,l9_65,l9_69);
unpackValues(l9_63.w,l9_65,l9_69);
unpackValues(l9_63.z,l9_65,l9_69);
unpackValues(l9_63.y,l9_65,l9_69);
unpackValues(l9_63.x,l9_65,l9_69);
int l9_78[8];
l9_78[0]=l9_56[0];
l9_78[1]=l9_56[1];
l9_78[2]=l9_56[2];
...
l9_78[6]=l9_56[6];
l9_78[7]=l9_56[7];
unpackValues(l9_64.w,l9_65,l9_78);
unpackValues(l9_64.z,l9_65,l9_78);
unpackValues(l9_64.y,l9_65,l9_78);
unpackValues(l9_64.x,l9_65,l9_78);
}
l9_61=l9_64;
l9_60=l9_63;
l9_59=l9_62;
...
mediump vec4 l9_83=texture2D(sc_OITFilteredDepthBoundsTexture,l9_54);
vec2 l9_84=l9_83.xy;
int l9_85;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_85=encodeDepth(((1.0-l9_83.x)*1000.0)+l9_86,l9_84);
}
#else
{
l9_85=0;
...
#endif
int l9_87=encodeDepth(viewSpaceDepth(),l9_84);
vec4 l9_88;
l9_88=l9_27*l9_27.w;
vec4 l9_89;
int l9_90=0;
...
if (l9_90<8)
{
int l9_91=l9_55[l9_90];
int l9_92=l9_87-l9_85;
...
if (l9_94)
{
vec3 l9_95=l9_88.xyz*(1.0-(float(l9_56[l9_90])*0.00392157));
