...
vec4 sc_SampleViewLevel(vec2 texSize,vec2 uv,int renderingLayout,int viewIndex,float level,highp sampler2D texsmp)
{
return sc_InternalTextureLevel(texSize,sc_SamplingCoordsViewToGlobal(uv,renderingLayout,viewIndex).xy,level,texsmp);
}
vec4 sc_SampleTextureLevel(vec2 samplerDims,int renderingLayout,int viewIndex,vec2 uv,bool useUvTransform,mat3 uvTransform,ivec2 softwareWrapModes,bool useUvMinMax,vec4 uvMinMax,bool useClampToBorder,vec4 borderColor,float level,highp sampler2D texture_sampler_)
{
...
#endif
varColor=color;
vec3 l9_44=varNormal;
vec2 l9_45=vec2(0.0);
l9_45.x=fract(((floor(float(sc_GetLocalInstanceID())+0.5)*2.0)+1.0)/(Tweak_N1Size.x*2.0));
vec2 l9_46=l9_45;
l9_46.y=(((floor(float(sc_GetLocalInstanceID())+0.5)/Tweak_N1Size.y)*2.0)+1.0)/(Tweak_N1Size.y*2.0);
int l9_47;
...
#endif
vec4 l9_48=sc_SampleTextureLevel(Tweak_N1Dims.xy,Tweak_N1Layout,l9_47,l9_46,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1),(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0),Tweak_N1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0),Tweak_N1BorderColor,0.0,Tweak_N1);
int l9_49;
...
#endif
vec4 l9_50=sc_SampleTextureLevel(baseTexDims.xy,baseTexLayout,l9_49,l9_46,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec3 l9_51=l9_50.xyz;
vec3 l9_52=l9_48.xyz-l9_51;
vec3 l9_53=vec3(0.0);
l9_53.x=l9_52.y;
vec3 l9_54=l9_53;
l9_54.y=-l9_52.x;
...
varPos=(((l9_55*l9_57)*vec3(l9_7.x+(-0.5)))*vec3(width*(cameraSize*0.05)))+(l9_51+(l9_52*vec3(l9_7.y)));
varNormal=normalize(l9_44);
vec3 l9_58=normalize(varTangent.xyz);
varTangent=vec4(l9_58.x,l9_58.y,l9_58.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_59=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
vec4 l9_60;
#if (sc_RenderingSpace==2)
{
l9_60=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
vec4 l9_61;
#if (sc_RenderingSpace==1)
{
l9_61=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
l9_61=l9_21;
...
#if (sc_RenderingSpace==4)
{
l9_63=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_21)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_64;
...
#if (sc_RenderingSpace==1)
{
l9_65=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_65=vec4(0.0);
...
#endif
vec4 l9_67=sc_ProjectorMatrix*l9_66;
varShadowTex=((l9_67.xy/vec2(l9_67.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_68;
...
{
vec4 l9_69=l9_62;
l9_69.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_62.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_62.w;
l9_68=l9_69;
}
#else
{
...
{
float l9_70=dot(l9_68,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_70);
}
#else
{
varClipDistance=l9_70;
}
#endif
}
#endif
...
float l9_76=l9_75;
vec2 l9_77=vec2(l9_72,0.5);
l9_77.x=l9_76;
float l9_78=0.5;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).y);
float l9_79=l9_78;
vec2 l9_80=l9_77;
l9_80.y=l9_79;
vec2 l9_81;
...
{
l9_83=ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).x==3;
}
#else
{
...
float l9_84=l9_76;
float l9_85=1.0;
sc_ClampUV(l9_84,intensityTextureUvMinMax.x,intensityTextureUvMinMax.z,l9_83,l9_85);
vec2 l9_86=l9_80;
l9_86.x=l9_84;
float l9_87=l9_85;
bool l9_88;
#if (SC_USE_CLAMP_TO_BORDER_intensityTexture)
{
l9_88=ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).y==3;
}
#else
{
l9_88=(int(SC_USE_CLAMP_TO_BORDER_intensityTexture)!=0);
}
#endif
float l9_89=l9_79;
float l9_90=l9_87;
sc_ClampUV(l9_89,intensityTextureUvMinMax.y,intensityTextureUvMinMax.w,l9_88,l9_90);
vec2 l9_91=l9_86;
l9_91.y=l9_89;
l9_82=l9_90;
l9_81=l9_91;
...
{
l9_92=vec2((intensityTextureTransform*vec3(l9_81,1.0)).xy);
}
#else
{
l9_92=l9_81;
...
float l9_93=l9_92.x;
float l9_94=l9_82;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).x,l9_74,l9_94);
vec2 l9_95=l9_92;
l9_95.x=l9_93;
float l9_96=l9_92.y;
float l9_97=l9_94;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture).y,l9_74,l9_97);
vec2 l9_98=l9_95;
l9_98.y=l9_96;
float l9_99=l9_97;
vec4 l9_100=sc_SampleView(intensityTextureDims.xy,l9_98,intensityTextureLayout,l9_73,0.0,intensityTexture);
vec4 l9_101;
#if (SC_USE_CLAMP_TO_BORDER_intensityTexture)
{
l9_101=mix(intensityTextureBorderColor,l9_100,vec4(l9_99));
}
#else
{
l9_101=l9_100;
...
#endif
float l9_102=(((l9_101.x*256.0)+l9_101.y)+(l9_101.z*0.00390625))*0.0622559;
float l9_103;
#if (BLEND_MODE_FORGRAY)
{
l9_103=max(l9_102,1.0);
}
#else
{
l9_103=l9_102;
...
{
vec3 l9_106=vec3(0.0);
l9_106.x=l9_70.x;
vec3 l9_107=l9_106;
l9_107.y=l9_70.y;
vec3 l9_108=l9_107;
l9_108.z=RGBToHSL(l9_69).z;
l9_105=HSLToRGB(l9_108);
}
#else
{
vec3 l9_109=vec3(0.0);
l9_109.x=transformSingleColor(l9_71,l9_104,l9_70.x);
vec3 l9_110=l9_109;
l9_110.y=transformSingleColor(l9_71,l9_104,l9_70.y);
vec3 l9_111=l9_110;
l9_111.z=transformSingleColor(l9_71,l9_104,l9_70.z);
l9_105=clamp(l9_111,vec3(0.0),vec3(1.0));
}
#endif
l9_68=l9_105;
}
...
{
if (baseColor.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
#if (sc_OITDepthBoundsPass)
{
float l9_3=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_3),min(1.0,l9_3+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_4=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_4).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_5=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_4).xy);
float l9_6=packValue(l9_5);
vec4 l9_7=vec4(0.0);
l9_7.x=l9_6;
vec4 l9_9=l9_7;
l9_9.y=packValue(l9_5);
vec4 l9_11=l9_9;
l9_11.z=packValue(l9_5);
vec4 l9_13=l9_11;
l9_13.w=packValue(l9_5);
vec4 l9_15=vec4(0.0);
l9_15.x=packValue(l9_5);
vec4 l9_17=l9_15;
l9_17.y=packValue(l9_5);
vec4 l9_19=l9_17;
l9_19.z=packValue(l9_5);
vec4 l9_20=l9_19;
l9_20.w=packValue(l9_5);
int l9_21=int(l9_2.w*255.0);
float l9_22=packValue(l9_21);
vec4 l9_23=vec4(0.0);
l9_23.x=l9_22;
vec4 l9_25=l9_23;
l9_25.y=packValue(l9_21);
vec4 l9_27=l9_25;
l9_27.z=packValue(l9_21);
vec4 l9_28=l9_27;
l9_28.w=packValue(l9_21);
sc_writeFragData0(l9_20);
sc_writeFragData1(l9_13);
sc_writeFragData2(l9_28);
...
if (l9_40==0)
{
l9_43=texture2D(sc_OITAlpha0,l9_29);
l9_42=texture2D(sc_OITDepthLow0,l9_29);
l9_41=texture2D(sc_OITDepthHigh0,l9_29);
}
else
{
l9_43=l9_36;
...
if (l9_40==1)
{
l9_39=texture2D(sc_OITAlpha1,l9_29);
l9_38=texture2D(sc_OITDepthLow1,l9_29);
l9_37=texture2D(sc_OITDepthHigh1,l9_29);
}
else
{
l9_39=l9_43;
...
if (any(notEqual(l9_37,vec4(0.0)))||any(notEqual(l9_38,vec4(0.0))))
{
int l9_44[8];
l9_44[0]=l9_30[0];
l9_44[1]=l9_30[1];
...
l9_44[6]=l9_30[6];
l9_44[7]=l9_30[7];
unpackValues(l9_37.w,l9_40,l9_44);
unpackValues(l9_37.z,l9_40,l9_44);
unpackValues(l9_37.y,l9_40,l9_44);
unpackValues(l9_37.x,l9_40,l9_44);
unpackValues(l9_38.w,l9_40,l9_44);
unpackValues(l9_38.z,l9_40,l9_44);
unpackValues(l9_38.y,l9_40,l9_44);
unpackValues(l9_38.x,l9_40,l9_44);
int l9_53[8];
l9_53[0]=l9_31[0];
l9_53[1]=l9_31[1];
l9_53[2]=l9_31[2];
...
l9_53[6]=l9_31[6];
l9_53[7]=l9_31[7];
unpackValues(l9_39.w,l9_40,l9_53);
unpackValues(l9_39.z,l9_40,l9_53);
unpackValues(l9_39.y,l9_40,l9_53);
unpackValues(l9_39.x,l9_40,l9_53);
}
l9_36=l9_39;
l9_35=l9_38;
l9_34=l9_37;
...
mediump vec4 l9_58=texture2D(sc_OITFilteredDepthBoundsTexture,l9_29);
vec2 l9_59=l9_58.xy;
int l9_60;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_60=encodeDepth(((1.0-l9_58.x)*1000.0)+l9_61,l9_59);
}
#else
{
l9_60=0;
...
#endif
int l9_62=encodeDepth(viewSpaceDepth(),l9_59);
vec4 l9_63;
l9_63=l9_2*l9_2.w;
vec4 l9_64;
int l9_65=0;
...
if (l9_65<8)
{
int l9_66=l9_30[l9_65];
int l9_67=l9_62-l9_60;
bool l9_68=l9_66<l9_67;
bool l9_69;
if (l9_68)
{
l9_69=l9_30[l9_65]>0;
...
if (l9_69)
{
vec3 l9_70=l9_63.xyz*(1.0-(float(l9_31[l9_65])*0.00392157));
l9_64=vec4(l9_70.x,l9_70.y,l9_70.z,l9_63.w);
}
else
{
l9_64=l9_63;
