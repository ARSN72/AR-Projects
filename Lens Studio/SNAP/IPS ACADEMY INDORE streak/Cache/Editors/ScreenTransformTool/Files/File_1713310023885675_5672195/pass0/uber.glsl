...
//texture texture2D sc_ScreenTexture 2:11:2:20
//SG_REFLECTION_END
...
float l9_12=l9_9+(1.0-l9_11);
float l9_13=floor(float(yUpPin));
float l9_14;
if (l9_13==0.0)
{
l9_14=0.0;
...
float l9_16=floor(float(yDownPin));
bool l9_17=l9_16==0.0;
float l9_18;
if (l9_17)
{
l9_18=0.0;
...
float l9_20=l9_18-l9_14;
float l9_21=(shapeHeightY*l9_20)+l9_14;
float l9_22;
if (l9_18>l9_14)
{
l9_22=clamp(l9_21,l9_14,l9_18);
}
else
{
l9_22=clamp(l9_21,l9_18,l9_14);
}
float l9_23;
if (l9_17)
{
...
l9_24.x=l9_12;
vec2 l9_25=l9_24;
l9_25.y=l9_22+(yOffset+l9_23);
vec2 l9_26=(varPackedTex.xy+l9_25)-vec2(0.5);
float l9_27=radians(shapeRotation);
float l9_28=sin(l9_27);
float l9_29=cos(l9_27);
float l9_30=clamp(shapeWidthX,0.0,1.0);
float l9_31=clamp(shapeHeightY,0.0,1.0);
vec2 l9_32=vec2(0.0);
l9_32.x=l9_30;
vec2 l9_33=l9_32;
l9_33.y=l9_31;
float l9_34=max(min(min(abs(shapeRoundness),l9_30),l9_31),0.001);
vec4 l9_35=vec4(0.5,0.5,0.5,0.0);
l9_35.w=0.0;
float l9_36=1.0-(length(max((abs(((vec2(dot(vec2(l9_29,l9_28),l9_26),dot(vec2(-l9_28,l9_29),l9_26))+vec2(0.5))*vec2(2.0))+vec2(-1.0))-l9_33)+vec2(l9_34),vec2(0.0)))/l9_34);
float l9_37=fwidth(l9_36);
float l9_38=(clamp((l9_36/l9_37)+0.001,0.001,1.001)-0.001)*shapeAlpha;
vec4 l9_39=mix(l9_35,vec4(shapeColor.xyz,1.0),vec4(clamp((l9_38-max(0.0,l9_38))+l9_38,0.0,1.0)));
float l9_40=l9_39.w;
#if (sc_BlendMode_AlphaTest)
{
...
{
if (l9_40<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_41=ngsPixelShader(l9_39);
vec4 l9_42=max(l9_41,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_44=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_44),min(1.0,l9_44+0.00392157),0.0,0.0));
}
#endif
}
#else
...
vec4 l9_54=l9_52;
l9_54.w=packValue(l9_46);
vec4 l9_56=vec4(0.0);
l9_56.x=packValue(l9_46);
vec4 l9_58=l9_56;
l9_58.y=packValue(l9_46);
vec4 l9_60=l9_58;
l9_60.z=packValue(l9_46);
vec4 l9_61=l9_60;
l9_61.w=packValue(l9_46);
int l9_62=int(l9_43.w*255.0);
float l9_63=packValue(l9_62);
vec4 l9_64=vec4(0.0);
l9_64.x=l9_63;
vec4 l9_66=l9_64;
l9_66.y=packValue(l9_62);
vec4 l9_68=l9_66;
l9_68.z=packValue(l9_62);
vec4 l9_69=l9_68;
l9_69.w=packValue(l9_62);
sc_writeFragData0(l9_61);
sc_writeFragData1(l9_54);
sc_writeFragData2(l9_69);
...
if (l9_81==0)
{
l9_84=texture2D(sc_OITAlpha0,l9_70);
l9_83=texture2D(sc_OITDepthLow0,l9_70);
l9_82=texture2D(sc_OITDepthHigh0,l9_70);
}
else
{
l9_84=l9_77;
...
if (l9_81==1)
{
l9_80=texture2D(sc_OITAlpha1,l9_70);
l9_79=texture2D(sc_OITDepthLow1,l9_70);
l9_78=texture2D(sc_OITDepthHigh1,l9_70);
}
else
{
l9_80=l9_84;
...
l9_85[6]=l9_71[6];
l9_85[7]=l9_71[7];
unpackValues(l9_78.w,l9_81,l9_85);
unpackValues(l9_78.z,l9_81,l9_85);
unpackValues(l9_78.y,l9_81,l9_85);
unpackValues(l9_78.x,l9_81,l9_85);
unpackValues(l9_79.w,l9_81,l9_85);
unpackValues(l9_79.z,l9_81,l9_85);
unpackValues(l9_79.y,l9_81,l9_85);
unpackValues(l9_79.x,l9_81,l9_85);
int l9_94[8];
l9_94[0]=l9_72[0];
l9_94[1]=l9_72[1];
l9_94[2]=l9_72[2];
...
l9_94[6]=l9_72[6];
l9_94[7]=l9_72[7];
unpackValues(l9_80.w,l9_81,l9_94);
unpackValues(l9_80.z,l9_81,l9_94);
unpackValues(l9_80.y,l9_81,l9_94);
unpackValues(l9_80.x,l9_81,l9_94);
}
l9_77=l9_80;
l9_76=l9_79;
l9_75=l9_78;
...
mediump vec4 l9_99=texture2D(sc_OITFilteredDepthBoundsTexture,l9_70);
...
#endif
l9_101=encodeDepth(((1.0-l9_99.x)*1000.0)+l9_102,l9_100);
}
#else
{
l9_101=0;
...
#endif
int l9_103=encodeDepth(viewSpaceDepth(),l9_100);
vec4 l9_104;
l9_104=l9_43*l9_43.w;
vec4 l9_105;
int l9_106=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_106<8)
{
int l9_107=l9_71[l9_106];
int l9_108=l9_103-l9_101;
bool l9_109=l9_107<l9_108;
bool l9_110;
if (l9_109)
{
l9_110=l9_71[l9_106]>0;
}
else
{
l9_110=l9_109;
...
if (l9_110)
{
vec3 l9_111=l9_104.xyz*(1.0-(float(l9_72[l9_106])*0.00392157));
