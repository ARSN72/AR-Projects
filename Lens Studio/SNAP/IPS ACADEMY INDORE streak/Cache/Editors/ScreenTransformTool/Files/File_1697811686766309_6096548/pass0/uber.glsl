...
//sampler sampler active_txtSmpSC 2:17
...
//texture texture2D active_txt 2:0:2:17
...
int active_txtGetStereoViewIndex()
{
int l9_0;
...
l9_18.z=0.871;
vec4 l9_19=l9_18;
l9_19.w=sc_SampleTextureBiasOrLevel(active_txtDims.xy,active_txtLayout,active_txtGetStereoViewIndex(),((varPackedTex.xy-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_active_txt)!=0),active_txtTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_active_txt,SC_SOFTWARE_WRAP_MODE_V_active_txt),(int(SC_USE_UV_MIN_MAX_active_txt)!=0),active_txtUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_active_txt)!=0),active_txtBorderColor,0.0,active_txt).w;
l9_11=l9_19;
}
