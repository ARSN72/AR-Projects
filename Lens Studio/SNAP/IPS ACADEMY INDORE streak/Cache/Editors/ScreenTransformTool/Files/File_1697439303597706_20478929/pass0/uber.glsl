...
vec4 l9_11=mix(l9_8,param_130,vec4(param_133));
vec4 l9_12=vec4(0.0);
l9_12.x=l9_11.x;
vec4 l9_13=l9_12;
l9_13.y=l9_11.y;
...
l9_5=l9_7*vec4(1.0,1.0,1.0,0.0);
}
vec4 l9_8;
if (l9_4!=0.0)
{
...
l9_15.z=0.871;
vec4 l9_16=l9_15;
l9_16.w=sc_SampleTextureBiasOrLevel(active_txtDims.xy,active_txtLayout,active_txtGetStereoViewIndex(),((varPackedTex.xy-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_active_txt)!=0),active_txtTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_active_txt,SC_SOFTWARE_WRAP_MODE_V_active_txt),(int(SC_USE_UV_MIN_MAX_active_txt)!=0),active_txtUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_active_txt)!=0),active_txtBorderColor,0.0,active_txt).w;
l9_8=l9_16;
}
float l9_17=l9_8.w*0.6;
vec4 l9_18=vec4(0.0);
l9_18.x=l9_8.x;
vec4 l9_19=l9_18;
l9_19.y=l9_8.y;
vec4 l9_20=l9_19;
l9_20.z=l9_8.z;
vec3 l9_21=mix(l9_5.xyz,l9_20.xyz,vec3(l9_17));
float l9_22=clamp((l9_5.w+l9_17)+0.001,0.001,1.001)-0.001;
...
{
if (l9_22<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_24=ngsPixelShader(l9_23);
...
#if (sc_OITDepthBoundsPass)
{
float l9_27=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_27),min(1.0,l9_27+0.00392157),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_28).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_29=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_28).xy);
...
vec4 l9_37=l9_35;
l9_37.w=packValue(l9_29);
vec4 l9_39=vec4(0.0);
l9_39.x=packValue(l9_29);
vec4 l9_41=l9_39;
l9_41.y=packValue(l9_29);
vec4 l9_43=l9_41;
l9_43.z=packValue(l9_29);
vec4 l9_44=l9_43;
l9_44.w=packValue(l9_29);
int l9_45=int(l9_26.w*255.0);
float l9_46=packValue(l9_45);
vec4 l9_47=vec4(0.0);
l9_47.x=l9_46;
vec4 l9_49=l9_47;
l9_49.y=packValue(l9_45);
vec4 l9_51=l9_49;
l9_51.z=packValue(l9_45);
vec4 l9_52=l9_51;
l9_52.w=packValue(l9_45);
sc_writeFragData0(l9_44);
sc_writeFragData1(l9_37);
sc_writeFragData2(l9_52);
...
#endif
l9_84=encodeDepth(((1.0-l9_82.x)*1000.0)+l9_85,l9_83);
}
#else
{
l9_84=0;
...
#endif
int l9_86=encodeDepth(viewSpaceDepth(),l9_83);
vec4 l9_87;
l9_87=l9_26*l9_26.w;
vec4 l9_88;
int l9_89=0;
...
if (l9_89<8)
{
int l9_90=l9_54[l9_89];
int l9_91=l9_86-l9_84;
...
if (l9_93)
{
vec3 l9_94=l9_87.xyz*(1.0-(float(l9_55[l9_89])*0.00392157));
