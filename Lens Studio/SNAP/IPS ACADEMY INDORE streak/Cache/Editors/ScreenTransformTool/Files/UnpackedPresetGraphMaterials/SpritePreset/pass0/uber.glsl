...
{
if (l9_4<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_6=ngsPixelShader(l9_5);
vec4 l9_7=max(l9_6,vec4(0.0));
sc_writeFragData0(l9_7);
vec4 l9_8=clamp(l9_7,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_9=clamp(viewSpaceDepth()*0.001,0.0,1.0);
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_10=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_10).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_11=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_10).xy);
float l9_12=packValue(l9_11);
vec4 l9_13=vec4(0.0);
l9_13.x=l9_12;
vec4 l9_15=l9_13;
l9_15.y=packValue(l9_11);
vec4 l9_17=l9_15;
l9_17.z=packValue(l9_11);
vec4 l9_19=l9_17;
l9_19.w=packValue(l9_11);
vec4 l9_21=vec4(0.0);
l9_21.x=packValue(l9_11);
vec4 l9_23=l9_21;
l9_23.y=packValue(l9_11);
vec4 l9_25=l9_23;
l9_25.z=packValue(l9_11);
vec4 l9_26=l9_25;
l9_26.w=packValue(l9_11);
int l9_27=int(l9_8.w*255.0);
...
vec4 l9_34=l9_33;
l9_34.w=packValue(l9_27);
sc_writeFragData0(l9_26);
sc_writeFragData1(l9_19);
sc_writeFragData2(l9_34);
...
if (l9_46==0)
{
l9_49=texture2D(sc_OITAlpha0,l9_35);
l9_48=texture2D(sc_OITDepthLow0,l9_35);
l9_47=texture2D(sc_OITDepthHigh0,l9_35);
}
else
{
l9_49=l9_42;
...
if (l9_46==1)
{
l9_45=texture2D(sc_OITAlpha1,l9_35);
l9_44=texture2D(sc_OITDepthLow1,l9_35);
l9_43=texture2D(sc_OITDepthHigh1,l9_35);
}
else
{
l9_45=l9_49;
...
if (any(notEqual(l9_43,vec4(0.0)))||any(notEqual(l9_44,vec4(0.0))))
{
int l9_50[8];
l9_50[0]=l9_36[0];
l9_50[1]=l9_36[1];
...
l9_50[6]=l9_36[6];
l9_50[7]=l9_36[7];
unpackValues(l9_43.w,l9_46,l9_50);
unpackValues(l9_43.z,l9_46,l9_50);
unpackValues(l9_43.y,l9_46,l9_50);
unpackValues(l9_43.x,l9_46,l9_50);
unpackValues(l9_44.w,l9_46,l9_50);
unpackValues(l9_44.z,l9_46,l9_50);
unpackValues(l9_44.y,l9_46,l9_50);
unpackValues(l9_44.x,l9_46,l9_50);
int l9_59[8];
l9_59[0]=l9_37[0];
l9_59[1]=l9_37[1];
l9_59[2]=l9_37[2];
...
l9_59[6]=l9_37[6];
l9_59[7]=l9_37[7];
unpackValues(l9_45.w,l9_46,l9_59);
unpackValues(l9_45.z,l9_46,l9_59);
unpackValues(l9_45.y,l9_46,l9_59);
unpackValues(l9_45.x,l9_46,l9_59);
}
l9_42=l9_45;
l9_41=l9_44;
l9_40=l9_43;
...
mediump vec4 l9_64=texture2D(sc_OITFilteredDepthBoundsTexture,l9_35);
vec2 l9_65=l9_64.xy;
int l9_66;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_66=encodeDepth(((1.0-l9_64.x)*1000.0)+l9_67,l9_65);
}
#else
{
l9_66=0;
...
#endif
int l9_68=encodeDepth(viewSpaceDepth(),l9_65);
vec4 l9_69;
l9_69=l9_8*l9_8.w;
vec4 l9_70;
int l9_71=0;
...
if (l9_71<8)
{
int l9_72=l9_36[l9_71];
int l9_73=l9_68-l9_66;
bool l9_74=l9_72<l9_73;
bool l9_75;
if (l9_74)
{
l9_75=l9_36[l9_71]>0;
...
if (l9_75)
{
vec3 l9_76=l9_69.xyz*(1.0-(float(l9_37[l9_71])*0.00392157));
l9_70=vec4(l9_76.x,l9_76.y,l9_76.z,l9_69.w);
}
else
{
l9_70=l9_69;
