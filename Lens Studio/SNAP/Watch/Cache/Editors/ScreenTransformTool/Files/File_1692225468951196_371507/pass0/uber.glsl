...
{
if (l9_72<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
#if (sc_OITDepthBoundsPass)
{
float l9_76=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_76),min(1.0,l9_76+0.00392157),0.0,0.0));
}
#endif
}
#else
...
l9_80.x=l9_79;
vec4 l9_82=l9_80;
l9_82.y=packValue(l9_78);
vec4 l9_84=l9_82;
l9_84.z=packValue(l9_78);
vec4 l9_86=l9_84;
l9_86.w=packValue(l9_78);
vec4 l9_88=vec4(0.0);
l9_88.x=packValue(l9_78);
vec4 l9_90=l9_88;
l9_90.y=packValue(l9_78);
vec4 l9_92=l9_90;
l9_92.z=packValue(l9_78);
vec4 l9_93=l9_92;
l9_93.w=packValue(l9_78);
int l9_94=int(l9_75.w*255.0);
float l9_95=packValue(l9_94);
vec4 l9_96=vec4(0.0);
l9_96.x=l9_95;
vec4 l9_98=l9_96;
l9_98.y=packValue(l9_94);
vec4 l9_100=l9_98;
l9_100.z=packValue(l9_94);
vec4 l9_101=l9_100;
l9_101.w=packValue(l9_94);
sc_writeFragData0(l9_93);
sc_writeFragData1(l9_86);
sc_writeFragData2(l9_101);
...
if (l9_113==0)
{
l9_116=texture2D(sc_OITAlpha0,l9_102);
l9_115=texture2D(sc_OITDepthLow0,l9_102);
l9_114=texture2D(sc_OITDepthHigh0,l9_102);
}
else
{
l9_116=l9_109;
...
if (l9_113==1)
{
l9_112=texture2D(sc_OITAlpha1,l9_102);
l9_111=texture2D(sc_OITDepthLow1,l9_102);
l9_110=texture2D(sc_OITDepthHigh1,l9_102);
}
else
{
l9_112=l9_116;
...
l9_117[6]=l9_103[6];
l9_117[7]=l9_103[7];
unpackValues(l9_110.w,l9_113,l9_117);
unpackValues(l9_110.z,l9_113,l9_117);
unpackValues(l9_110.y,l9_113,l9_117);
unpackValues(l9_110.x,l9_113,l9_117);
unpackValues(l9_111.w,l9_113,l9_117);
unpackValues(l9_111.z,l9_113,l9_117);
unpackValues(l9_111.y,l9_113,l9_117);
unpackValues(l9_111.x,l9_113,l9_117);
int l9_126[8];
l9_126[0]=l9_104[0];
l9_126[1]=l9_104[1];
l9_126[2]=l9_104[2];
...
l9_126[6]=l9_104[6];
l9_126[7]=l9_104[7];
unpackValues(l9_112.w,l9_113,l9_126);
unpackValues(l9_112.z,l9_113,l9_126);
unpackValues(l9_112.y,l9_113,l9_126);
unpackValues(l9_112.x,l9_113,l9_126);
}
l9_109=l9_112;
l9_108=l9_111;
l9_107=l9_110;
...
mediump vec4 l9_131=texture2D(sc_OITFilteredDepthBoundsTexture,l9_102);
...
#endif
l9_133=encodeDepth(((1.0-l9_131.x)*1000.0)+l9_134,l9_132);
}
#else
{
l9_133=0;
...
#endif
int l9_135=encodeDepth(viewSpaceDepth(),l9_132);
vec4 l9_136;
l9_136=l9_75*l9_75.w;
vec4 l9_137;
int l9_138=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_138<8)
{
int l9_139=l9_103[l9_138];
int l9_140=l9_135-l9_133;
bool l9_141=l9_139<l9_140;
bool l9_142;
if (l9_141)
{
l9_142=l9_103[l9_138]>0;
}
else
{
l9_142=l9_141;
...
if (l9_142)
{
vec3 l9_143=l9_136.xyz*(1.0-(float(l9_104[l9_138])*0.00392157));
