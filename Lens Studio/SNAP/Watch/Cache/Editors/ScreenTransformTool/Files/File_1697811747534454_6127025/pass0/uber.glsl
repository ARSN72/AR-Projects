...
l9_14.z=0.968;
vec4 l9_15=l9_14;
l9_15.w=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),((varPackedTex.xy-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w;
l9_11=l9_15;
}
else
{
...
l9_18.z=0.871;
vec4 l9_19=l9_18;
l9_19.w=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),((varPackedTex.xy-vec2(0.5))*vec2(1.25))+vec2(0.5),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex).w;
l9_11=l9_19;
}
vec3 l9_20=mix(l9_6.xyz,l9_11.xyz,vec3(l9_11.w));
float l9_21=clamp((l9_6.w+l9_11.w)+0.001,0.001,1.001)-0.001;
...
{
if (l9_21<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_23=ngsPixelShader(l9_22);
vec4 l9_24=max(l9_23,vec4(0.0));
sc_writeFragData0(l9_24);
vec4 l9_25=clamp(l9_24,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_26=clamp(viewSpaceDepth()*0.001,0.0,1.0);
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_27).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_28=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_27).xy);
float l9_29=packValue(l9_28);
vec4 l9_30=vec4(0.0);
l9_30.x=l9_29;
vec4 l9_32=l9_30;
l9_32.y=packValue(l9_28);
vec4 l9_34=l9_32;
l9_34.z=packValue(l9_28);
vec4 l9_36=l9_34;
l9_36.w=packValue(l9_28);
vec4 l9_38=vec4(0.0);
l9_38.x=packValue(l9_28);
vec4 l9_40=l9_38;
l9_40.y=packValue(l9_28);
vec4 l9_42=l9_40;
l9_42.z=packValue(l9_28);
vec4 l9_43=l9_42;
l9_43.w=packValue(l9_28);
int l9_44=int(l9_25.w*255.0);
float l9_45=packValue(l9_44);
vec4 l9_46=vec4(0.0);
l9_46.x=l9_45;
vec4 l9_48=l9_46;
l9_48.y=packValue(l9_44);
vec4 l9_50=l9_48;
l9_50.z=packValue(l9_44);
vec4 l9_51=l9_50;
l9_51.w=packValue(l9_44);
sc_writeFragData0(l9_43);
sc_writeFragData1(l9_36);
sc_writeFragData2(l9_51);
...
#endif
l9_83=encodeDepth(((1.0-l9_81.x)*1000.0)+l9_84,l9_82);
}
#else
{
l9_83=0;
...
#endif
int l9_85=encodeDepth(viewSpaceDepth(),l9_82);
vec4 l9_86;
l9_86=l9_25*l9_25.w;
vec4 l9_87;
int l9_88=0;
...
if (l9_88<8)
{
int l9_89=l9_53[l9_88];
int l9_90=l9_85-l9_83;
...
if (l9_92)
{
vec3 l9_93=l9_86.xyz*(1.0-(float(l9_54[l9_88])*0.00392157));
